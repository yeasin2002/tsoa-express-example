...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsTodoController_listTodos: Record<string, TsoaRoute.ParameterSchema> = {
                ...
                completed: {"in":"query","name":"completed","dataType":"boolean"},
                limit: {"default":100,"in":"query","name":"limit","dataType":"double"},
                offset: {"default":0,"in":"query","name":"offset","dataType":"double"},
        };
        app.get('/todos',
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsTodoController_getUserTodos: Record<string, TsoaRoute.ParameterSchema> = {
                userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
                completed: {"in":"query","name":"completed","dataType":"boolean"},
        };
        app.get('/todos/user/:userId',
            ...(fetchMiddlewares<RequestHandler>(TodoController)),
            ...(fetchMiddlewares<RequestHandler>(TodoController.prototype.getUserTodos)),

            async function TodoController_getUserTodos(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTodoController_getUserTodos, request, response });
